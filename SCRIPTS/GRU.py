# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 12:09:29 2019
...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 21:30:38 2019
...
def experiment(series,look_back,neurons,n_epoch):
    ...
    # fit the model
    GRU_model = fit_GRU(train_scaled, 1, n_epoch, neurons)
    ...
    print(GRU_model.summary()) #line plot of observed vs predicted
